...
//   }
   ...
   public void initialize() {
      ...
      btnNewButton_1.setIcon(new ImageIcon(EducationManagerView.class.getResource("/img/[크기변환]등록스.jpg")));
      ...
      btnNewButton_2.setIcon(new ImageIcon(EducationManagerView.class.getResource("/img/[크기변환]에딧.png")));
      ...
      btnNewButton_3.setIcon(new ImageIcon(EducationManagerView.class.getResource("/img/[크기변환]지워.png")));
...
//   }
   ...
   class EducationBusinessModel extends AbstractTableModel {
      ...
      String[] columnNames = { "순번", "교육 이름", "교육시작날짜", "교육종료날짜", "교육참가인원", "교육내용", "교육대상", "지역번호_읍면동" };
